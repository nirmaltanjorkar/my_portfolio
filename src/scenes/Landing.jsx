    ...
    return (
        ...
        className="md:flex md:justify-between md:items-center md:h-full gap-20 py-10">
            ...
            <div className="md:order-2 flex justify-center basis-3/5 z-10 mt-16 md:mt-30">
                ...
                {/* MAIN SECTION */}
                <div className="z-30 basis-3/5 mt-16 md:mt-30">
                    ...
                    <p className="realtive font-semibold text-4xl font-playfair z-10 text-center md:text-start">
                        ...
                        As a highly motivated Software Development Engineer, I have a passion for creating 
                        innovative software solutions that exceed user expectations. I recently completed my 
                        Master of Science in Management Information Systems from the University of Illinois 
                        at Chicago. 
                        </p>
                    </motion.dev>
